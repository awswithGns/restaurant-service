...
public class RestaurantControllerTest {
    ...
    public void testAddRestaurant()
    {
        ...
        RestaurantDTO restaurantDTO=new RestaurantDTO(1,"restaurant 1","aanand nagar","pune","famous for test");

        // Mock the service behavior
        when(restaurantService.addRestaurantInDB(restaurantDTO)).thenReturn(restaurantDTO);

        // Call the controller method
        ResponseEntity<RestaurantDTO> response = restaurantController.addRestaurantInDB(restaurantDTO);
